...
#
# Created: Thu Aug 14 17:06:02 2014
...
class Ui_fileType(object):
    def setupUi(self, fileType):
        ...
        fileType.resize(300, 200)
        fileType.setMinimumSize(QtCore.QSize(216, 135))
        fileType.setMaximumSize(QtCore.QSize(300, 200))
        ...
        self.gridLayout.addWidget(self.ParamButton, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.CoordButton, 2, 0, 1, 1)
